...
class PlayerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        timeObserver =
        simplePlayer.addPeriodicTimeObserver(forInterval: CMTime(seconds: 1, preferredTimescale: 10), queue: DispatchQueue.main, using: {time in self.updateTime(time: time)})
    }
